...
type Cashbankoutjurnal struct {
	Cashbankoutjurnalid int `gorm:"column:cashbankoutjurnalid;primaryKey" json:"cashbankoutjurnalid"`
...
func (Cashbankoutjurnal) TableName() string {
	return "cashbankoutjurnal"
}
