...
type Post struct {
	...
	Useraccess   Useraccess `gorm:"foreignKey:useraccessid;references:useraccessid" json:"useraccess"`

	Postcategory []Postcategory `gorm:"foreignKey:postid;references:postid" json:"postcategory"`
}
