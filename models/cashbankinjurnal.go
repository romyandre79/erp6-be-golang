...
type Cashbankinjurnal struct {
	Cashbankinjurnalid int `gorm:"column:cashbankinjurnalid;primaryKey" json:"cashbankinjurnalid"`
...
func (Cashbankinjurnal) TableName() string {
	return "cashbankinjurnal"
}
