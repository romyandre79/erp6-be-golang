...
type Invoicearjurnal struct {
	Invoicearjurnalid int `gorm:"column:invoicearjurnalid;primaryKey" json:"invoicearjurnalid"`
...
func (Invoicearjurnal) TableName() string {
	return "invoicearjurnal"
}
